...
public class GameBackground extends JPanel
{
	...
	public GameBackground()//initalize
	{
		...
		dancefloor = getImage(getDocumentBase(), "danceFloor2.png");
		...
		for (int i = 1; i < 55; i++)
		{
			particleList.add(new Particle(r.nextInt(200)+ 15, r.nextInt(200)+ 10, r.nextInt(25)+1, r.nextInt(25)+1, 100, 100, hue[r.nextInt(6)]));
		}
			...
			public void paintComponent(Graphics g)//Put your shapes in here
				{
					...
					g.drawImage(dancefloor, 100, 675, this);
